...
# Write data.frames
write.table(x = Riaz2017_Clinical.df, file = "../data/Riaz2017_Clinical.tsv", sep = "\t", row.names = F)
write.table(x = Riaz2017_GE.df, file = "../data/Riaz2017_GE.tsv", sep = "\t", row.names = F)
```
...
# Write data.frames
write.table(x = Combined_Clinical.df, file = "../data/Combined_Clinical.df.tsv", sep = "\t", row.names = F)
write.table(x = Combined_GE.df, file = "../data/Combined_GE.df.tsv", sep = "\t", row.names = F)
```
